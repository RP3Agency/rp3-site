...
* Change any instance of "template" (Sass file name, gulpfile.js, JS, index.php, package.json) to a code representative of this case study.  Examples: wawf, ripleys
* All markup should go on index.php.
* All Sass is to be edited in src/sass/*
* All JS is to be edited in src/js/template.js (renamed; see above)
