...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.synced_folder "wp-content/uploads", "/vagrant/wp-content/uploads", id: "uploads", owner: "www-data", group: "www-data", :mount_options => ["dmode=777,fmode=666"]
  config.vm.synced_folder "wp-content/uploads/wp-migrate-db", "/vagrant/wp-content/uploads/wp-migrate-db", id: "migrate-db-uploads", owner: "www-data", group: "www-data", :mount_options => ["dmode=777,fmode=666"]
end
