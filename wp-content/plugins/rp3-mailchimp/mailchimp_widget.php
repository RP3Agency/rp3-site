...
function mailchimpSF_signup_form($args = array()) {
    ...
    if ( isset( $mc_subheader_content ) ) {
        $sub_heading = trim( $mc_subheader_content );
    } else {
...
<?php if ( ! isset( $mc_submit_text ) ) $mc_submit_text = get_option( 'mc_submit_text' ); ?>

			<input type="submit" name="mc_signup_submit" id="mc_signup_submit" value="<?php echo esc_attr( $mc_submit_text ); ?>" class="button" />
