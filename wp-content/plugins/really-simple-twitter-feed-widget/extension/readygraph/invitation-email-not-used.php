...
function rstw_disconnectReadyGraph(){
...
rstw_rrmdir($dir);
	...
	if(isset($_GET["action"]) && base64_decode($_GET["action"]) == "changeaccount")rstw_disconnectReadyGraph();
	if(isset($_GET["action"]) && base64_decode($_GET["action"]) == "deleteaccount")rstw_deleteReadyGraph();
