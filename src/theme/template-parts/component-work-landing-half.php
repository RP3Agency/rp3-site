...
if ( get_sub_field( 'half_width_featured_image_alt' ) ) {
	...
	<div class="work__half">
		...
		<a href="<?php echo esc_url( get_the_permalink() ); ?>" class="work__link block">
			...
			<div class="work__image work__image--half">
				...
				$image['small'] = wp_get_attachment_image_src( get_field( 'work_landing_image_half' ), 'four_three_small' );
				$image['small_2x'] = wp_get_attachment_image_src( get_field( 'work_landing_image_half' ), 'four_three_small_2x' );

				$image['medium'] = wp_get_attachment_image_src( get_field( 'work_landing_image_half' ), 'four_three_medium' );
				$image['medium_2x'] = wp_get_attachment_image_src( get_field( 'work_landing_image_half' ), 'four_three_medium_2x' );

				$image['large'] = wp_get_attachment_image_src( get_field( 'work_landing_image_half' ), 'four_three_large' );
				$image['large_2x'] = wp_get_attachment_image_src( get_field( 'work_landing_image_half' ), 'four_three_large_2x' );
				?>
